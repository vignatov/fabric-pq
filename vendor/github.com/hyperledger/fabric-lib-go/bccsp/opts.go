...
const (
	...
	// QS Quantum-safe algorithm family label.
	QS = "QS"
...
// OQSGoPublicKeyImportOpts contains options for OQS public key importation from go oqs struct format.
...
// from an x509 certificate extension.
